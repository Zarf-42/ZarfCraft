...
func _ready():
	...
	# This means the map will be the same every time you run the game.
	...
	#for distance in range(1, render_distance + 1):
		...
		#for x in range(-distance, distance + 1):
			#for y in range(-distance, distance + 1):
				## Currently, we check for Y, which I think is altitude despite not being
				## altitude elsewhere. I think we should just skip Y check here and do altitude-based
